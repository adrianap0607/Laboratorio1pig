...
class Dice {
    private int faceValue; //Se declaran los atributos del objeto 
...
class Game {
    ...
    public Game() {
        //se establece que serán dos jugadores en total
    ...
    public void play() {
        // Condiciones del juego que el punteo sea menor a 100 el juego continua, se crea un loop
        while (players[0].getScore() < 100 && players[1].getScore() < 100) {
            Player currentPlayer = players[currentPlayerIndex];

            System.out.println("Turno del jugador " + (currentPlayerIndex + 1) + ":");
// Se crean las opciones si el jugador quiere lanzar o ceder su turno
...
// se establece que el primer jugador en llegar a 100 o más puntos gana la partida 
...
// opción de volver a jugar o terminar el juego
